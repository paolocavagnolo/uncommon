...
SOCK_FILE = 'sock/displayA1.socket'
...
cv2.namedWindow('Image_A_Frame',cv2.WINDOW_NORMAL)
cv2.setWindowProperty('Image_A_Frame',cv2.WND_PROP_FULLSCREEN,cv2.WINDOW_FULLSCREEN)
cv2.setWindowProperty('Image_A_Frame', cv2.WND_PROP_TOPMOST, 1)
